...
function FormEditScheduleComponents() {
  ...
  const getDataAudioName = async () => {
    try {
      const response = await axios.get("https://smartaudio.lumiconn.id/audio");
  ...
  const getScheduleById = async (id) => {
    try {
      const response = await axios.get(`https://smartaudio.lumiconn.id/schedule/${id}`);
  ...
  const handleEditSchedule = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://smartaudio.lumiconn.id/schedule/${id}`, scheduleData);
